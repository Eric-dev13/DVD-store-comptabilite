...
const routes: Routes = [
  { path: "admin", component: DvdsComponent }, // DVDS
  { path: "admin/dvd/nouveau", component: FormDvdComponent }, // post
  { path: "admin/dvd/update/:id", component: FormDvdComponent }, // put-update
  { path: "admin/dvd/:id", component: DvdComponent }, // // get by id

  { path: "admin/clients", component: ClientsComponent }, // CLIENTS
  { path: "admin/client/nouveau", component: FormClientComponent }, // post
  { path: "admin/client/update/:id", component: FormClientComponent }, // put-update
  { path: "admin/client/:id", component: ClientComponent }, // // get by id

  { path: "admin/ventes", component: VentesComponent }, // VENTES
  { path: "admin/vente/nouveau", component: FormVenteComponent }, // post
  { path: "admin/vente/update/:id", component: FormVenteComponent }, // put-update
